...
public class CustomerServiceImpl implements CustomerService<Customer> {
    ...
    @Override
    public Page<Customer> findAllWithRequirement(String name, String phone, String email, Pageable pageable) {
        System.out.println("test");
        Page<Customer> customers = this.repository.findAllWithRequirement(name, phone, email, pageable);
        return  customers;
    }
